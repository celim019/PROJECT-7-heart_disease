...
X = data['age', 'sex', '', 'cp', 'trestbps', 'chol', 'fbs', 'restecg', 'thalach', 'exang', 'oldpeak', 'slope', 'ca', 'thal'] # Adjust features as needed
y = data['target']  # Target variable for house prices
